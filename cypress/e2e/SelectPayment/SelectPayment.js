...
Then("I have to look at the payment form as well as enter payment details",function(){
    console.log("I have to look at the payment form as well as enter payment details")
});
And("click the pay button",function(){
